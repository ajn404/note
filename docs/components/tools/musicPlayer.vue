      ...
      <div class="player__top">
        <div class="player-cover">
          <transition-group :name="transitionName">
            <!-- <div class="player-cover__item" :style="{ backgroundImage: `url(${tracks[currentTrackIndex].cover})` }" ></div> -->
            <template  v-for="(track, $index) in tracks" :key="$index">
              <div v-if="$index === currentTrackIndex" class="player-cover__item" :style="{ backgroundImage: `url(${track.cover})` }" ></div>
            </template>
          </transition-group>
        </div>
